...
import { PomodoroTimer } from "../src/components/PomodoroTimer.jsx";
import { ProgressDashboard } from "../src/components/ProgressDashboard.jsx";
import { TimetableGenerator } from "../src/components/TimetableGenerator.jsx";  // Import the Timetable Generator
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "20px" }}>
        ...
        {activeTab === "TimetableGenerator" && (  
          <div>
            ...
            <TimetableGenerator /> {/* Render Timetable Generator component */}
          </div>
        )}
      </div>
    </div>
